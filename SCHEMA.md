...
Generated 2026-08-02 · 20 databases
...
| 9 | `mockup_shots` | Mockup Shots | 5 |
| 10 | `mockup_templates` | Mockup Templates | 18 |
| 11 | `shipping_profiles` | Shipping Profiles | 8 |
| 12 | `products` | Products | 39 |
| 13 | `product_variants` | Product Variants | 10 |
| 14 | `designs` | Designs | 43 |
| 15 | `etsy_listings` | Etsy Listings | 34 |
| 16 | `change_log` | Change Log | 7 |
| 17 | `workflow_log` | Workflow Log | 9 |
| 18 | `keywords` | Keywords | 17 |
| 19 | `image_slots` | Image Slots | 10 |
| 20 | `design_derivatives` | Design Derivatives | 10 |
...
| --- | --- | --- |
| Name | title |  |
| Crop Rect (JSON) | rich_text |  |
| Crop Set At | date |  |
| Framing Flagged | checkbox |  |
| Framing Notes | rich_text |  |
...
| Fit | select | Fit inside · Fill area · Fill width from top |
...
| --- | --- | --- |
| Name | title |  |
| Etsy Shipping Profile ID | number |  |
| Origin Country | rich_text |  |
| Domestic Handling Fee | number |  |
| International Handling Fee | number |  |
| Destinations (JSON) | rich_text |  |
| Raw Profile (JSON) | rich_text |  |
| Synced At | date |  |
...
| Shipping Cost Source | select | Printify catalog |
| Shipping Pulled At | date |  |
| Etsy Shipping Profile | relation | → Shipping Profiles |
| Currency | select | USD |
...
| Keyword Imports (JSON) | rich_text |  |
...
| Momentum | select | Selling now · Steady · Legacy · Unknown |
| Momentum Detail (JSON) | rich_text |  |
| Pulled At | date |  |
